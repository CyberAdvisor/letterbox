...
Version 1.0 exists to demonstrate that 
the concept is technically sound and 
to invite scrutiny of the design and 
implementation.
...
- Reviewed for edge cases in production 
  ...
  iOS versions
- Validated against all failure modes 
...
If you use this and something breaks, 
you were warned.
...
Are there behaviors specific to 
...
the observed behavior, the expected 
...
no server, no organization of any kind. 
...
this application in 2025 will be 
equally secure in 2075 given a 
...
specialize in exactly your situation.
...
If you run this on another platform 
you are entirely on your own. 
No security claims are made. 
No support is provided. 
No bug reports or pull requests 
for other platforms will be accepted.
...
If you cannot review the code yourself, 
understand that you are trusting an 
implementation that has not been 
professionally verified, developed 
with AI assistance, by someone who 
understands security but is not a 
specialist in cryptographic 
implementation.

Use it with that understanding.

If your situation requires a 
professionally audited cryptographic 
