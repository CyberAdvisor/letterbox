...
# main.py ephemeral prompt changed from yes/no to d/n/q
(ok if "d  Delete" in code["main.py"] else fail)(
    "main.py contains ephemeral delete prompt (d/n/q)")

# ── 12. Version numbers ─────────────────────────────────────────────────────
(ok if "v1.1.0" in docs["HANDOFF.md"] else fail)("HANDOFF.md shows v1.1.0")
(ok if "1.2" in docs["README.md"] else fail)("README.md shows version 1.2")
