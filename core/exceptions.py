...
class UnknownPadError(PadError):
    """Pad ID not found in vault or not valid for receive."""
...
class PosteoConnectionError(TransportError):
    """
...
class DecryptionError(LetterboxError):
...
# ---------------------------------------------------------------------------
# Setup errors
# 2026-05-09  M.Lines   v3.1.0: v3.1.0 baseline release
# ---------------------------------------------------------------------------
